...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s khorium-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  khorium-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded khorium transaction") + "\n" +
              "  khorium-tx [options] -create [commands]   " + _("Create hex-encoded khorium transaction") + "\n" +
              "\n";
