...
```bash
    gpg --detach-sign ${VERSION}-linux/${SIGNER}/khorium-linux-build.assert
    gpg --detach-sign ${VERSION}-win/${SIGNER}/khorium-win-build.assert
    gpg --detach-sign ${VERSION}-osx-unsigned/${SIGNER}/khorium-osx-build.assert
```
