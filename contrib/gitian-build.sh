...
detachUrl=https://github.com/KHOGPU/khorium-detached-sigs
proc=2
mem=2000
lxc=true
...
Run this script from the directory containing the bitcoin, gitian-builder, gitian.sigs, and khorium-detached-sigs.
...
-u|--url	Specify the URL of the khorium repository. Default is https://github.com/KHOGPU/KHOGPU
-g|--gsigsUrl	Specify the URL of the gitian.sigs repository. Default is https://github.com/KHOGPU/gitian.sigs
-d|--detachUrl	Specify the URL of the khorium-detached-sigs repository. Default is https://github.com/KHOGPU/khorium-detached-sigs
...
then
    ...
    then
    	git clone $detachUrl khorium-detached-sigs
    fi
